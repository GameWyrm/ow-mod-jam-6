...
namespace Mod_Jam_6
{
    public class FurnaceValve : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            interact.ChangePrompt(ModJam6.Instance.NewHorizons.GetTranslationForUI(clockwise ? "$PH_VALVE_CLOCKWISE" : "$PH_VALVE_COUNTERCLOCKWISE"));
        }

        private void OnPressInteract()
        {
            FurnaceController.Instance.TurnValve(clockwise);
            Locator.GetShipLogManager().RevealFact("PH_LOG_FURNACE_2");
        }
    }
}
